...
export default function TaskListenWrongWord({ props, currentTask, setCurrentTask }) {
    ...
    return (
        <div className="TaskType-sound TaskType-ListenSelect TaskType-ListenWrongWord">
            <div className="TaskType-ListenWrongWord-reproductor">
