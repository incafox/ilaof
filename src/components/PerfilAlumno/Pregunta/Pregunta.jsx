...
function Pregunta() {
  ...
  return (
    <div id="pregunta" className="box-model">
      {loading ? (
        "...Cargando Datos"
      ) : (
        <img src={perfilAlumno.picture.large}></img>
      )}
      <p>{loading ? "...Cargando Datos" : perfilAlumno.name.first}</p>
      <div>
      ...
      <div>
        ...
        {showRightAnswer ? (
           ...
           <button className="button " onClick={closeResult}><Link to='/alumno/:id'>OK</Link></button>
           </div>
         </div>
        ) : null}
        {showWrongAnswer ? (
             ...
             <div className="overlay-container">
              <div className="text"><img src={correcto}></img></div>
             <button className="button " onClick={closeResult}><Link to='/reporte/:id'>OK</Link></button>
             </div>
           </div>
        ) : null}
      </div>
